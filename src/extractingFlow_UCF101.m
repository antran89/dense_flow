...
function extractingFlow_UCF101(index, device_id, type)
...
elseif type == 1
    path2 = '/media/data/ucf101_flow/ucf101_flow_img_tvl1_gpu_s2/';
elseif type == 2
    path2 = '/media/data/ucf101_flow/ucf101_flow_img_brox_gpu_s2/';
else
