...
FLOW_FOLDER=/media/tranlaman/fe84cec7-bfef-4885-809b-899f9e414762/ActivityNet/comp_flow_folder
IMG_FOLDER=/media/tranlaman/fe84cec7-bfef-4885-809b-899f9e414762/ActivityNet/img_folder
...
for i in `seq 1 $NUM_WORKERS`; do
	if [ $i == $NUM_WORKERS ]
		...
		python extract_comp_flow_videos_activitynet.py --dataset_folder=$VIDEO_FOLDER --flow_folder=$FLOW_FOLDER --img_folder=$IMG_FOLDER --new_height=$NEW_HEIGHT --new_width=$NEW_WIDTH \
