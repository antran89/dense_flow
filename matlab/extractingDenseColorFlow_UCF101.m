...
function extractingDenseColorFlow_UCF101(index, device_id, type)
...
if type ==0
    path2 = '/media/data/ucf101_flow/ucf101_dense_color_flow_img_farn_gpu/';
elseif type ==1
    path2 = '/media/data/ucf101_flow/ucf101_dense_color_flow_img_tvl1_gpu/';
else
    path2 = '/media/data/ucf101_flow/ucf101_dense_color_flow_img_brox_gpu/';
end
